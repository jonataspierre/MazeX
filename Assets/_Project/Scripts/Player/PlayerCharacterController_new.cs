...
public class PlayerCharacterController_new : MonoBehaviourPun
{
    ...
    PhotonView PV;
    [SerializeField] PlayerManager_new playerManager;
    [SerializeField] PlayerInputHandler_new m_InputHandler;
    ...
    void Awake()
    {
        ...
        //m_Controller = PhotonView.Find((int)PV.InstantiationData[0]).GetComponent<CharacterController>();

        //m_Controller = FindObjectsOfType<CharacterController>();

        m_InputHandler = GetComponent<PlayerInputHandler_new>();
        //m_InputHandler = FindObjectOfType<PlayerInputHandler_new>();
        //m_InputHandler = PhotonView.Find((int)PV.InstantiationData[0]).GetComponent<PlayerInputHandler_new>();
        ...
        //PlayerCamera.transform.position = new Vector3(0f, 1.5f, 0f);
    ...
    void Start()
    {
        ...
        //m_Controller = GetComponent<CharacterController>();
        //m_Controller = GetComponent<CharacterController>();
        //DebugUtility.HandleErrorIfNullGetComponent<CharacterController, PlayerCharacterController_new>(m_Controller,
        //    this, gameObject);

        //m_InputHandler = GetComponent<PlayerInputHandler_new>();
        //m_InputHandler = FindObjectOfType<PlayerInputHandler_new>();
        //DebugUtility.HandleErrorIfNullGetComponent<PlayerInputHandler_new, PlayerCharacterController_new>(m_InputHandler,
        //    this, gameObject);
